    ...
    var body: some View {
        Button("help") {
            ...
            Alert (title: Text ("Help"),
                   message: Text ("Choose a type of dice by clicking on it. Choose the number of dice you want to roll. You can roll more than one type of dice at a time. To make a roll press the roll button. "),
